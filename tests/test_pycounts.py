from psirving_pycounts.pycounts import count_words
from psirving_pycounts.plotting import plot_words
from psirving_pycounts.datasets import get_flatland
import matplotlib
